    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.body}>
          ...
          <Text style={styles.paragraph}>
            {donnees.APPRENANT_CIVILITE} {donnees.APPRENANT_NOM_COMPLET} est bien inscrit(e) dans notre établissement {donnees.MENTION_STATUT} et prépare la formation {donnees.FORMATION_LIBELLE} (code RNCP : {donnees.FORMATION_RNCP} — code diplôme : {donnees.FORMATION_CODE_DIPLOME}), dont le certificateur est le Ministère du Travail, du Plein Emploi et de l'Insertion.
          </Text>
          <Text style={styles.paragraph}>
